 ...
 */
public abstract class Hilt_CreatePostFragment extends ImagePickerFragment {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CreatePostFragment_GeneratedInjector) UnsafeCasts.<GeneratedComponentManagerHolder>unsafeCast(this).generatedComponent()).injectCreatePostFragment(UnsafeCasts.<CreatePostFragment>unsafeCast(this));
    }
  }
}
