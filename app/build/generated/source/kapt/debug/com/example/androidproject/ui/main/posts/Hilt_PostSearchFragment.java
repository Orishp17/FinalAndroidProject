 ...
 */
public abstract class Hilt_PostSearchFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PostSearchFragment() {
    super();
  }

  Hilt_PostSearchFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PostSearchFragment_GeneratedInjector) this.generatedComponent()).injectPostSearchFragment(UnsafeCasts.<PostSearchFragment>unsafeCast(this));
    }
  }
