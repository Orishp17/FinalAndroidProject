 ...
 */
public abstract class Hilt_RegisterFragment extends ImagePickerFragment {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RegisterFragment_GeneratedInjector) UnsafeCasts.<GeneratedComponentManagerHolder>unsafeCast(this).generatedComponent()).injectRegisterFragment(UnsafeCasts.<RegisterFragment>unsafeCast(this));
    }
  }
}
