 ...
 */
public abstract class Hilt_ImagePickerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ImagePickerFragment() {
    super();
  }

  Hilt_ImagePickerFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ImagePickerFragment_GeneratedInjector) this.generatedComponent()).injectImagePickerFragment(UnsafeCasts.<ImagePickerFragment>unsafeCast(this));
    }
  }
