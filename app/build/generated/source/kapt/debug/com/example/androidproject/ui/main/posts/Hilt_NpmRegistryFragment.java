 ...
 */
public abstract class Hilt_NpmRegistryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NpmRegistryFragment() {
    super();
  }

  Hilt_NpmRegistryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NpmRegistryFragment_GeneratedInjector) this.generatedComponent()).injectNpmRegistryFragment(UnsafeCasts.<NpmRegistryFragment>unsafeCast(this));
    }
  }
