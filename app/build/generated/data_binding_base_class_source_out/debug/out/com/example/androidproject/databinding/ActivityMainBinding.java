...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull FragmentContainerView fragmentContainerMain, @NonNull ProgressBar pbMain) {
    this.rootView = rootView;
    this.bottomNavigation = bottomNavigation;
    this.fragmentContainerMain = fragmentContainerMain;
    this.pbMain = pbMain;
  }
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.fragmentContainerMain;
      FragmentContainerView fragmentContainerMain = ViewBindings.findChildViewById(rootView, id);
