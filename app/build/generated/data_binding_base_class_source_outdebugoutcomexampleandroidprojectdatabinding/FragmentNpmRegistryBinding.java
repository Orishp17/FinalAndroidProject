...
public final class FragmentNpmRegistryBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentNpmRegistryBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentNpmRegistryBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentNpmRegistryBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_npm_registry, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentNpmRegistryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentNpmRegistryBinding((ConstraintLayout) rootView, btnBack, controlsLayout,
